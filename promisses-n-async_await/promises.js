...
createPost({ id: 3, title: 'Post Three', body: 'This is post three' }).then(getPosts).catch((err) => console.log(err));
...
// -----------------------  fetch, de http request ------------------

//  fetch returns een promise, maar heeft 2x .then() methods,
// het  binnen gekomen result moet eerst tot .json geformatteerd worden.
